...
ITE_LINK_LIBRARY_IF_DEFINED(CFG_BUILD_WFSTASR wfstasr)
...
if (NOT("${CMAKE_PROJECT_NAME}" STREQUAL "bootloader"))
    ...
    if (DEFINED CFG_NET_WIFI_SDIO_NGPL_AP6256)
        ITE_LINK_LIBRARY_IF_DEFINED(CFG_NET_LWIP
            ${PROJECT_SOURCE_DIR}/sdk/driver/non_gpl_wifi_mhd/wlan_lib/libmhd4345x-LwIP_1_4_1.a
        )
        ITE_LINK_LIBRARY_IF_DEFINED(CFG_NET_LWIP_2
            ${PROJECT_SOURCE_DIR}/sdk/driver/non_gpl_wifi_mhd/wlan_lib/libmhd4345x-LwIP_2_1_2.a
        )
    endif()

    if (DEFINED CFG_NET_WIFI_SDIO_NGPL_AP6236)
        ITE_LINK_LIBRARY_IF_DEFINED(CFG_NET_LWIP
            ${PROJECT_SOURCE_DIR}/sdk/driver/non_gpl_wifi_mhd/wlan_lib/libmhd4343x-LwIP_1_4_1.a
        )
        ITE_LINK_LIBRARY_IF_DEFINED(CFG_NET_LWIP_2
            ${PROJECT_SOURCE_DIR}/sdk/driver/non_gpl_wifi_mhd/wlan_lib/libmhd4343x-LwIP_2_1_2.a
        )
    endif()

    if (DEFINED CFG_NET_WIFI_SDIO_NGPL_AP6212)
        ITE_LINK_LIBRARY_IF_DEFINED(CFG_NET_LWIP
            ${PROJECT_SOURCE_DIR}/sdk/driver/non_gpl_wifi_mhd/wlan_lib/libmhd43438-LwIP_1_4_1.a
        )
        ITE_LINK_LIBRARY_IF_DEFINED(CFG_NET_LWIP_2
            ${PROJECT_SOURCE_DIR}/sdk/driver/non_gpl_wifi_mhd/wlan_lib/libmhd43438-LwIP_2_1_2.a
        )
    endif()
    if (DEFINED CFG_NET_WIFI_SDIO_NGPL_AP6203)
        ITE_LINK_LIBRARY_IF_DEFINED(CFG_NET_LWIP
            ${PROJECT_SOURCE_DIR}/sdk/driver/non_gpl_wifi_mhd/wlan_lib/libmhd4301x-LwIP_1_4_1.a
        )
        ITE_LINK_LIBRARY_IF_DEFINED(CFG_NET_LWIP_2
            ${PROJECT_SOURCE_DIR}/sdk/driver/non_gpl_wifi_mhd/wlan_lib/libmhd4301x-LwIP_2_1_2.a
        )
    endif()
...
if (DEFINED CFG_BUILD_BLUETOOTH)
	if (DEFINED CFG_BUILD_NIMBLE)
		...
		if (DEFINED CFG_RTL8723BLE OR DEFINED CFG_AP6212BLE OR DEFINED CFG_AP6236BLE OR DEFINED CFG_AP6256BLE)
        target_link_libraries(${CMAKE_PROJECT_NAME}
            bluetooth
        )
		endif()
...
if (DEFINED CFG_BUILD_QRENCODE)
    target_link_libraries(${CMAKE_PROJECT_NAME}
        qrencode
    )
endif()

ITE_LINK_LIBRARY_IF_DEFINED(CFG_BTA bluetooth_bta)
        ...
        if (DEFINED CFG_NOR_ENABLE AND DEFINED CFG_UPGRADE_NOR_IMAGE AND NOT (${CMAKE_PROJECT_NAME} STREQUAL bootloader))
            ...
            if (DEFINED CFG_FS_LFS)
                ...
                add_custom_command(
                    ...
                    POST_BUILD
                    COMMAND lfstool
                    ARGS --tsize=${CFG_NOR_PARTITION0_SIZE},${CFG_NOR_PARTITION1_SIZE},${CFG_NOR_PARTITION2_SIZE},${CFG_NOR_PARTITION3_SIZE} --target=${CMAKE_BINARY_DIR}/project/${CMAKE_PROJECT_NAME}/${CFG_UPGRADE_NOR_IMAGE_FILENAME} --datapath=${CMAKE_BINARY_DIR}/data --reserversize=${CFG_NOR_RESERVED_SIZE}
                )
            endif()
