...
#define ITH_LCD_WIDTH_MASK              (0x0FFF << ITH_LCD_WIDTH_BIT)

#define ITH_LCD_HEIGHT_REG              0x0008
#define ITH_LCD_HEIGHT_BIT              16
#define ITH_LCD_HEIGHT_MASK             (0x0FFF << ITH_LCD_HEIGHT_BIT)

#define ITH_LCD_PITCH_REG               0x000C
#define ITH_LCD_PITCH_BIT               0
#define ITH_LCD_PITCH_MASK              (0x3FFF << ITH_LCD_PITCH_BIT)
