...
void
endian_put_le16(void *buf, uint16_t x)
{
    uint8_t *u8ptr;
...
void
endian_put_le24(void *buf, uint32_t x)
{
    uint8_t *u8ptr;
...
void
endian_put_le32(void *buf, uint32_t x)
{
    uint8_t *u8ptr;
...
void
endian_put_le64(void *buf, uint64_t x)
{
    uint8_t *u8ptr;
...
uint16_t
endian_get_le16(const void *buf)
{
    const uint8_t *u8ptr;
    uint16_t x;
...
uint32_t
endian_get_le24(const void *buf)
{
    const uint8_t *u8ptr;
    uint32_t x;
...
uint32_t
endian_get_le32(const void *buf)
{
    const uint8_t *u8ptr;
    uint32_t x;
...
uint64_t
endian_get_le64(const void *buf)
{
    const uint8_t *u8ptr;
    uint64_t x;
...
void
endian_put_be16(void *buf, uint16_t x)
{
    uint8_t *u8ptr;
...
void
endian_put_be24(void *buf, uint32_t x)
{
    uint8_t *u8ptr;
...
void
endian_put_be32(void *buf, uint32_t x)
{
    uint8_t *u8ptr;
...
void
endian_put_be64(void *buf, uint64_t x)
{
    uint8_t *u8ptr;
...
uint16_t
endian_get_be16(const void *buf)
{
    const uint8_t *u8ptr;
    uint16_t x;
...
uint32_t
endian_get_be24(const void *buf)
{
    const uint8_t *u8ptr;
    uint32_t x;
...
uint32_t
endian_get_be32(const void *buf)
{
    const uint8_t *u8ptr;
    uint32_t x;
...
uint64_t
endian_get_be64(const void *buf)
{
    const uint8_t *u8ptr;
    uint64_t x;
