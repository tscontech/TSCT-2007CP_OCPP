                                            ...
                                            uint8_t filter_policy)
{
    ...
    TEST_ASSERT(endian_get_le16(param + 1) == itvl);
    TEST_ASSERT(endian_get_le16(param + 3) == scan_window);
...
ble_gap_test_util_verify_tx_disconnect(void)
{
    ...
    TEST_ASSERT(endian_get_le16(param + 0) == 2);
...
ble_gap_test_util_verify_tx_update_conn(struct ble_gap_upd_params *params)
{
    ...
    TEST_ASSERT(endian_get_le16(param + 0) == 2);
    TEST_ASSERT(endian_get_le16(param + 2) == params->itvl_min);
    TEST_ASSERT(endian_get_le16(param + 4) == params->itvl_max);
    TEST_ASSERT(endian_get_le16(param + 6) == params->latency);
    TEST_ASSERT(endian_get_le16(param + 8) == params->supervision_timeout);
    TEST_ASSERT(endian_get_le16(param + 10) == params->min_ce_len);
    TEST_ASSERT(endian_get_le16(param + 12) == params->max_ce_len);
}
...
ble_gap_test_util_verify_tx_params_reply_pos(void)
{
    ...
    TEST_ASSERT(endian_get_le16(param + 0) == 2);
    TEST_ASSERT(endian_get_le16(param + 2) == ble_gap_test_conn_self_params.itvl_min);
    TEST_ASSERT(endian_get_le16(param + 4) == ble_gap_test_conn_self_params.itvl_max);
    TEST_ASSERT(endian_get_le16(param + 6) == ble_gap_test_conn_self_params.latency);
    TEST_ASSERT(endian_get_le16(param + 8) ==
                ble_gap_test_conn_self_params.supervision_timeout);
    TEST_ASSERT(endian_get_le16(param + 10) ==
                ble_gap_test_conn_self_params.min_ce_len);
    TEST_ASSERT(endian_get_le16(param + 12) ==
                                         ...
                                         uint8_t disc_mode)
{
    ...
    hci_cmd.min_interval = endian_get_le16(hci_buf + 0);
    hci_cmd.max_interval = endian_get_le16(hci_buf + 2);
