                     ...
                     void *arg)
{
    ...
    endian_put_le16(buf + 0, entry->handle);
    endian_put_le16(buf + 2, entry->end_group_handle);
                         ...
                         void *arg)
{
    ...
    endian_put_le16(buf + 1, attr_handle + 1);
                                ...
                                uint8_t *out_cur_clt_cfg_flags)
{
    ...
    *out_cur_clt_cfg_flags = clt_cfg->flags;
    ...
    case BLE_GATT_ACCESS_OP_READ_DSC:
        ...
        endian_put_le16(buf, clt_cfg->flags & ~BLE_GATTS_CLT_CFG_F_RESERVED);
        break;
    ...
    case BLE_GATT_ACCESS_OP_WRITE_DSC:
        ...
        flags = endian_get_le16(om->om_data);
