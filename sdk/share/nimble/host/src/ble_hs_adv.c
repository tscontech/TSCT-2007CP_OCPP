                            ...
                            struct os_mbuf *om)
{
    ...
    for (i = 0; i < num_elems; i++) {
        ...
        if (om) {
            ...
            endian_put_le32(dst + *dst_len, elems[i].value);
            *dst_len += 4;
        }
    }
                       ...
                       struct os_mbuf *om)
{
    ...
    for (i = 0; i < num_elems; i++) {
        if (om) {
            ...
            endian_put_le16(dst + *dst_len, elems[i]);
                           ...
                           uint8_t src_len)
{
    ...
    *total_len = src[0] + 1;
    ...
    case BLE_HS_ADV_TYPE_APPEARANCE:
        ...
        adv_fields->appearance = endian_get_le16(data);
    ...
    case BLE_HS_ADV_TYPE_ADV_ITVL:
        ...
        adv_fields->adv_itvl = endian_get_le16(data);
