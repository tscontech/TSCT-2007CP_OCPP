                                 ...
                                 struct ble_att_read_type_adata *adata)
{
    ...
    case BLE_GATTS_INC_SVC_LEN_NO_UUID:
        proc->find_inc_svcs.cur_start = endian_get_le16(adata->value + 0);
        proc->find_inc_svcs.cur_end = endian_get_le16(adata->value + 2);
        call_cb = 0;
        break;

    case BLE_GATTS_INC_SVC_LEN_UUID:
        service.start_handle = endian_get_le16(adata->value + 0);
        service.end_handle = endian_get_le16(adata->value + 2);
                                 ...
                                 struct ble_att_read_type_adata *adata)
{
    ...
    chr.val_handle = endian_get_le16(adata->value + 1);
