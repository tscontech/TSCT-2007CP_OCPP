...
static inline atomic_val_t atomic_set(atomic_t *target, atomic_val_t value)
{
     ...
     */
	atomic_val_t tmp = *target;
	*target = value;
	return tmp;// __atomic_exchange_n(target, value, __ATOMIC_SEQ_CST);
}
...
{
	return *target | value;//__atomic_fetch_or(target, value, __ATOMIC_SEQ_CST);
}
...
{
	return *target & value;//__atomic_fetch_and(target, value, __ATOMIC_SEQ_CST);
}
