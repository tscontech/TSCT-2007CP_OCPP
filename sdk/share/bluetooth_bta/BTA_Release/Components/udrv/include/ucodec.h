...
**  Description:
**
**  This file contains codec definitions from Universal Embedded
**  Drivers API.
**
...
**
******************************************************************************/
extern tUCODEC_STATUS UCODEC_Start(tUCODEC_ID codec_id);
...
**
******************************************************************************/
extern void UCODEC_Stop(tUCODEC_ID codec_id);
