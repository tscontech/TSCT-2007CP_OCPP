...
#define GKI_BUFFER_DEBUG_EXTEND TRUE
...
/* Task management
*/
GKI_API extern void    GKI_set_task_prio_stack(taskinfo_t *);
...
GKI_API extern void    GKI_freebuf_T (void *, char const*, int);
GKI_API extern void   *GKI_getbuf_T (UINT16, char const*, int);
GKI_API extern void   *GKI_getpoolbuf_T (UINT8, char const*, int);
GKI_API extern void   GKI_send_msg_T (UINT8 task_id, UINT8 mbox, void *msg, char const * function, int line);
#else
...
GKI_API extern BOOLEAN  GKI_check_buf_from_gki (void *);
...
GKI_API extern void    GKI_print_free(void);
#if ((defined GKI_BUFFER_DEBUG_EXTEND) && (GKI_BUFFER_DEBUG_EXTEND == TRUE))
GKI_API extern void    GKI_print_alloced(UINT8 pool_id);
...
#if ((defined GKI_BUFFER_DEBUG_EXTEND) && (GKI_BUFFER_DEBUG_EXTEND == TRUE))
#define GKI_freebuf(p_buf)   GKI_freebuf_T ((p_buf), __FUNCTION__, __LINE__)
#define GKI_getbuf(size)     GKI_getbuf_T ((size), __FUNCTION__, __LINE__)
#define GKI_getpoolbuf(pool_id) GKI_getpoolbuf_T ((pool_id),  __FUNCTION__, __LINE__)
#define GKI_send_msg(task_id, mbox, msg)  GKI_send_msg_T ((task_id), (mbox), (msg), __FUNCTION__, __LINE__)
#endif

extern void GKI_dump_status(void);

extern void GKI_shut_down(void);
