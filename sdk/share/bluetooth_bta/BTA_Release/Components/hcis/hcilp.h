...
extern void HCILP_SetParameters(UINT8 bt_controller_idle_threshold, UINT16 bt_wake_idle_timeout);
extern void HCILP_GetParameters(UINT8* bt_controller_idle_threshold, UINT16* bt_wake_idle_timeout);
