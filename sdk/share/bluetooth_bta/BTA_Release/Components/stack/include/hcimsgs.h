...
HCI_API extern BOOLEAN btsnd_hcic_any(UINT8* buf, UINT16 len);
...
#define HCIC_PARAM_SIZE_SET_DEFAULT_PHY                 3
...
#if (defined HCI_NOT_USED_FOR_STACK) && (HCI_NOT_USED_FOR_STACK == FALSE)
#if ((SMP_INCLUDED == TRUE) && (SMP_LE_SC_INCLUDED == TRUE))
HCI_API extern BOOLEAN btsnd_hcic_ble_read_local_p_256_publ_key (void);
#define HCIC_PARAM_SIZE_BLE_R_LOCAL_P_256_PUBL_KEY  0

#define HCIC_BLE_P_256_X_COORD_SIZE                 32
#define HCIC_BLE_P_256_Y_COORD_SIZE                 32
HCI_API extern BOOLEAN btsnd_hcic_ble_generate_dhkey (
    UINT8 p_256_x_coord[HCIC_BLE_P_256_X_COORD_SIZE],
    UINT8 p_256_y_coord[HCIC_BLE_P_256_Y_COORD_SIZE]);
#define HCIC_PARAM_SIZE_BLE_GENERATE_DHKEY  \
    HCIC_BLE_P_256_X_COORD_SIZE + HCIC_BLE_P_256_Y_COORD_SIZE
#endif
#endif  /* (defined HCI_NOT_USED_FOR_STACK) && (HCI_NOT_USED_FOR_STACK == FALSE) */
...
HCI_API extern  BOOLEAN btsnd_hcic_ble_set_phy (UINT16 handle, UINT8 all_phys, UINT8 tx_phys,
