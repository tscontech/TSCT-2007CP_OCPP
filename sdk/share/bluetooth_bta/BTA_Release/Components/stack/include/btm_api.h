...
#endif
    ,BTM_SET_PRIVACY_SUCCESS,           /* 21 enable/disable local privacy success */
    BTM_SET_PRIVACY_FAIL,               /* 22 enable/disable local privacy failed*/
};
...
/*******************************************************************************
**
** Function         BTM_SetLocalDeviceNameLE
**
** Description      This function is called to set the local device name.
**
** Returns          BTM_CMD_STARTED if successful, otherwise an error
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SetLocalDeviceNameLE (char *p_name);
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_GetLERole (BD_ADDR remote_bd_addr, UINT8 *p_role);
...
/*******************************************************************************
**
** Function         BTM_ReadBleAdvTxPower
**
** Description      This function is called to read the current
**                  TX power of Ble Adv. The tx power level results
**                  are returned in the callback.
**                  (tBTM_RSSI_RESULTS)
**
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_ReadBleAdvTxPower (tBTM_CMPL_CB *p_cb);
