...
#define  GATT_WRITE_REJECTED                 0xFC /* write rejected */
...
//Define BT service struct for Add Service blob
/**
 * @brief Attribute types.
 */
typedef enum
{
    GATT_DB_PrimaryService,     /**< Primary service. */
    GATT_DB_SecondaryService,   /**< Secondary service. */
    GATT_DB_IncludedService,    /**< Included service. */
    GATT_DB_CharacteristicDecl, /**< Characteristic declaration. */
    GATT_DB_Characteristic,     /**< Characteristic. */
    GATT_DB_Descriptor,         /**< Characteristic descriptor. */
} tGATT_DB_AttributeType;
...
typedef enum
{
    GATT_DB_ServiceTypePrimary,   /**< Primary service. */
    GATT_DB_ServiceTypeSecondary, /**< Secondary service. */
} tGATT_DB_GattServiceTypes;
...
typedef enum
{
    GATT_BTuuidType16 = 1, /**< 16 bit UUID */
    GATT_BTuuidType32 = 2, /**< 32 bit UUID */
    GATT_BTuuidType128 = 3 /**< 128 bit UUID */
} tBTuuidType;
...
typedef struct
{
    tBTuuidType ucType; /**< UUID type */
    union
    {
        UINT16 uu16;                      /**< UUID, 16 bits. */
        UINT32 uu32;                      /**< UUID, 32 bits. */
        UINT8 uu128[ LEN_UUID_128 ];      /**< UUID, 128 bits. */
    } uu;
} tBTUuid;

typedef struct Gatt_DB_Service tGATT_DB_Service;
...
typedef struct
{
    tBTUuid xUuid;   /**< Service UUID. */
    UINT8 ucInstId; /**< Service instance ID. */
} tBTGattInstanceId;
...
typedef struct
{
    tBTGattInstanceId         xId;            /**< Service instance ID. */
    tGATT_DB_GattServiceTypes xServiceType; /**< Service type. */
} tBTGattSrvcId;
...
typedef struct
{
    tBTUuid xUuid;                   /**< Attribute UUID*/
    UINT16           xProperties;   /**< Characteristic properties. */
    tGATT_PERM       xPermissions; /**< Characteristic permissions. */
} tGATT_DB_Characteristic;
...
{
    tBTUuid xUuid;                   /**< Attribute UUID*/
    tGATT_PERM xPermissions;          /**< Descriptor permissions. */
} tGATT_DB_CharacteristicDescr;
...
{
    tBTUuid xUuid;               /**< Attribute UUID*/
    tGATT_DB_Service *pxPtrToService; /**< Pointer to the service being included. */
} tGATT_DB_IncludedService;

/**
 * @brief  Structure describing a service UUID.
 */
typedef tBTUuid tGATT_DB_ServiceUUID;
...
typedef struct
{
    tGATT_DB_AttributeType  xAttributeType; /**< Type of attribute. */
    union
    {
        tGATT_DB_ServiceUUID         xServiceUUID;                 /**< UUID of the service. */
        tGATT_DB_Characteristic      xCharacteristic;           /**< Characteristic. */
        tGATT_DB_CharacteristicDescr xCharacteristicDescr; /**< Descriptor. */
        tGATT_DB_IncludedService     xIncludedService;         /**< Included service. */
    };
} tGATT_DB_Attribute;
...
{
    UINT8                     ucInstId;                /**< Service Instance ID. */
    tGATT_DB_GattServiceTypes xType;      /**< Service type. */
    UINT32 xNumberOfAttributes;      /**< Number of attributes. */
    UINT16 *pusHandlesBuffer;     /**< Array of handles, mapping to pxBLEAttributes. */
    tGATT_DB_Attribute *pxBLEAttributes; /**< Array of attribute, can be allocated in ROM. */
};
...
**
*******************************************************************************/
GATT_API tGATT_STATUS GATTS_SetAttributeValue(UINT16 attr_handle, UINT16 length, UINT8 *value);
...
**
*******************************************************************************/
GATT_API tGATT_STATUS GATTS_GetAttributeValue(UINT16 attr_handle, UINT16 *length, UINT8 **value);
...
/*******************************************************************************
**
** Function         GATT_DisableAttrProfile
**
** Description      Deregister all GATT based profile.
**
** Returns          none
**
*******************************************************************************/
GATT_API extern void GATT_DisableAttrProfile (void);
...
GATT_API extern UINT16 GATTS_AddServiceBlob(tGATT_IF gatt_if, tGATT_DB_Service *pService );
