...
#define BTU_TTYPE_LPST                              61
#define BTU_TTYPE_LPST_SHADOW                       62
#define BTU_TTYPE_LPST_SYNC                         63
#endif
...
BTU_API void btu_hci_debug_mode_set(UINT8 mode);
BTU_API UINT8 btu_hci_debug_mode_get(void);
BTU_API void btu_hci_read_rssi_ble_rx_test(void);
BTU_API void btu_hci_need_forward_event(UINT8 needed);
BTU_API BOOLEAN btu_hci_read_raw_rssi(BD_ADDR rem_bda, tBT_TRANSPORT transport,void *cb);
