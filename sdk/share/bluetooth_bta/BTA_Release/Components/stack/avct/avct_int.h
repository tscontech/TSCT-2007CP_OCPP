...
#define AVCT_LPST_CB_LCB            0x01    // for tAVCT_LCB/BR
#define AVCT_LPST_CB_CLOSE          0x02    // for lcid

extern void avct_lpst_send_control_blocks (tAVCT_LCB *p_lcb);
extern void avct_lpst_send_close (UINT16 lcid);
#endif
