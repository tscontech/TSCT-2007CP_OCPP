...
#define HCI_READ_RAW_RSSI                   (0x0048 | HCI_GRP_VENDOR_SPECIFIC)
...
/* extended subcode for LE Meta VSE */
#define HCI_BRCM_VSE_BLE_META_RSSI_LINK             0x02
#define HCI_BRCM_VSE_BLE_META_RSSI_ADV              0x03
#define HCI_BRCM_VSE_BLE_META_LE_ROLE_SWITCH        0x06
#define HCI_BRCM_VSE_BLE_META_LPST_ROLE_SWITCH      0x0E
#define HCI_BRCM_VSE_BLE_META_LPST_PE_AWAY          0x0F    /* LPST Primary Away Event */
#define HCI_BRCM_VSE_BLE_META_LPST_SWITCH_FAIL      0x10    /* LPST role switch failure Event */
