...
#define     BTA_GATTC_KNOWN_SR_MAX    2
#endif
...
typedef tBTA_GATTC_API_OPEN tBTA_GATTC_API_CLOSE;
...
typedef union
{
    ...
    tBTA_GATTC_API_CLOSE        api_close;
...
#define BTA_GATTC_BUFFER_HELD     0x01
#define BTA_GATTC_CONN_RPTED      0x02
    UINT8               op_flag;
...
#define BTA_GATTC_SET_BUFFER_HELD(x)       ((x) |= BTA_GATTC_BUFFER_HELD)
#define BTA_GATTC_GET_BUFFER_HELD(x)       (((x) & BTA_GATTC_BUFFER_HELD) != 0)
#define BTA_GATTC_CLEAR_BUFFER_HELD(x)        ((x) &= ~BTA_GATTC_BUFFER_HELD)
#define BTA_GATTC_SET_CONN_RPTED(x)       ((x) |= BTA_GATTC_CONN_RPTED)
#define BTA_GATTC_GET_CONN_RPTED(x)       (((x) & BTA_GATTC_CONN_RPTED) != 0)
...
extern void bta_gattc_get_gatt_db(UINT16 conn_id, UINT16 start_handle,
                           UINT16 end_handle, btgatt_db_element_t** db,
                           int* count) ;
...
extern void bta_gattc_sys_disable(void);
