...
extern tBTA_DG_SCB *bta_dg_server_match(tBTA_DG_SCB *p_srv, BOOLEAN incl_name);
...
extern void bta_dg_setup_port(tBTA_DG_SCB *p_scb);

#if ( BRCM_LPST_INCLUDED == TRUE)
extern void bta_dg_lpst_sync (tBTA_DG_SCB *p_scb);
extern void bta_dg_lpst_process_control_blocks (UINT8 *p, UINT16 cb_len);
extern BOOLEAN bta_dg_lpst_profile_sync(void);
extern BOOLEAN bta_dg_lpst_validate_switch_state(void);
#endif
