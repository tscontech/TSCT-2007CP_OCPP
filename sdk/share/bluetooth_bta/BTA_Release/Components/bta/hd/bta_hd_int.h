...
{
    BT_HDR              hdr;
    char                service_name[HID_MAX_SVC_NAME_LEN];
...
typedef union
{
    ...
    tBTA_HD_VIRTUAL_UNPLUG  api_vir_unplug;
...
typedef struct
{
    ...
    tBTA_HD_PROTO       proto;          /* protocol (boot or report) */
    UINT8               app_id;
...
extern void bta_hd_listen_cb_act(tBTA_HD_CB *p_cb, tBTA_HD_DATA *p_data);
