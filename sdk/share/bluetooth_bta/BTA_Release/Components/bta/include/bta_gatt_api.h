...
#define bt128BIT_UUID_LEN 16
    ...
    union
    {
        ...
        UINT8  uu128[ bt128BIT_UUID_LEN ]; /**< UUID, 128 bits. */
    } uu;
} BtUuid_t;
...
#define BTA_GATTC_IND_CONF_EVT          41 /* GATTC send indication confirm event */
...
#define BTA_GATTC_TYPE_WRITE_PERPARE     GATT_WRITE_PREPARE
#define BTA_GATTC_TYPE_WRITE_SIGNED      GATT_WRITE_SIGNED
...
typedef union
{
    ...
    tBTA_GATTC_IND_CONF     conf;              /* send confirm to peer when receive the indication */
} tBTA_GATTC;
...
#define BTA_GATTS_RSP_EVT                               24
#define BTA_GATTS_ADD_SERVICE_BLOB_EVT                  25
...
typedef struct
{
    ...
    UINT16              *p_handle;
    tBTA_GATT_STATUS    status;
}tBTA_GATTS_ADD_SERVICE_BLOB_RESULT;
...
typedef struct
{
    tBTA_GATT_STATUS    status;     /* response status */
    tBTA_GATTS_RSP*     rsp;        /* pointer to tBTA_GATTS_RSP */
}tBTA_GATTS_RESPONSE;
...
typedef union
{
    ...
    tBTA_GATTS_RESPONSE     response;   /* BTA_GATTS_RSP_EVT callback data */
    tBTA_GATTS_ADD_SERVICE_BLOB_RESULT  serv_blob_result;  /* Service blob added callback data*/
}tBTA_GATTS;
...
**
*******************************************************************************/
BTA_API extern void BTA_GATTC_AppDeregister (tBTA_GATTC_IF client_if, tBTA_GATTC_CBACK *p_client_cb);
...
**
*******************************************************************************/
BTA_API extern void BTA_GATTC_CancelOpen(tBTA_GATTC_IF client_if, BD_ADDR remote_bda, BOOLEAN is_direct, tBTA_GATTC_CBACK *p_client_cb);
...
**
*******************************************************************************/
BTA_API extern void BTA_GATTC_Close(UINT16 conn_id, tBTA_GATTC_CBACK *p_client_cb);
...
**
*******************************************************************************/
BTA_API extern void BTA_GATTC_ServiceSearchRequest(UINT16 conn_id, tBT_UUID *p_srvc_uuid, tBTA_GATTC_CBACK *p_client_cb);
...
**
*******************************************************************************/
BTA_API extern void BTA_GATTC_SendIndConfirm (UINT16 conn_id, tBTA_GATTC_CHAR_ID *p_char_id, tBTA_GATTC_CBACK *p_client_cb);
...
**
*******************************************************************************/
BTA_API extern void BTA_GATTC_ExecuteWrite  (UINT16 conn_id, BOOLEAN is_execute, tBTA_GATTC_CBACK *p_client_cb);
...
BTA_API extern void BTA_GATTC_ReadMultiple(UINT16 conn_id, tBTA_GATTC_MULTI *p_read_multi,
                                           tBTA_GATT_AUTH_REQ auth_req, tBTA_GATTC_CBACK *p_client_cb);
...
**
*******************************************************************************/
BTA_API extern void BTA_GATTC_Refresh(BD_ADDR remote_bda, tBTA_GATTC_CBACK *p_client_cb);
...
**
*******************************************************************************/
BTA_API extern void BTA_GATTC_Listen(tBTA_GATTC_IF client_if, BOOLEAN start, BD_ADDR_PTR target_bda, tBTA_GATTC_CBACK *p_client_cb);
...
**
*******************************************************************************/
BTA_API extern void BTA_GATTC_ConfigureMTU (UINT16 conn_id, UINT16 mtu, tBTA_GATTC_CBACK *p_client_cb);
 ...
 *
 ******************************************************************************/
BTA_API extern tBTA_GATT_STATUS BTA_GATTC_GetGattDb(UINT16 conn_id, UINT16 start_handle,
                                                    UINT16 end_handle, btgatt_db_element_t** db, int* count);
...
/*******************************************************************************
**
** Function         BTA_GATTS_AddServiceBlob
**
** Description      This function is called to add all service blob.
**
** Parameters       service_id: service ID to which this charatceristic descriptor is to
**                              be added.
**
...
**
*******************************************************************************/
BTA_API extern void BTA_GATTS_AddServiceBlob (tBTA_GATTS_IF server_if, tGATT_DB_Service *pService);
