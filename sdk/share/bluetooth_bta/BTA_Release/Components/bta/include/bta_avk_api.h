...
#define BTA_AVK_NUM_STRS         1//2
#endif

#ifndef BTA_AVK_MAX_SEPS
#define BTA_AVK_MAX_SEPS         1//2
#endif
...
#define BTA_AVK_CODEC_PCM        0x5                     /* ram pcm */
#define BTA_AVK_CODEC_APTX       0x6                     /* apt-X */
#define BTA_AVK_CODEC_SEC        0x7                     /* SEC - Samsung Codec */
...
#define BTA_AVK_SIG_OPEN_EVT     2       /* A2DP signaling channel opened */
#define BTA_AVK_SIG_CLOSE_EVT    3       /* A2DP signaling channel closed */
#define BTA_AVK_OPEN_EVT         4       /* A2DP streaming channel opened */
#define BTA_AVK_CLOSE_EVT        5       /* A2DP streaming channel closed */
#define BTA_AVK_START_EVT        6       /* stream data transfer started */
#define BTA_AVK_STOP_EVT         7       /* stream data transfer stopped */
#define BTA_AVK_PROTECT_REQ_EVT  8       /* content protection request */
#define BTA_AVK_PROTECT_RSP_EVT  9       /* content protection response */
#define BTA_AVK_RC_OPEN_EVT      10      /* remote control channel opened */
#define BTA_AVK_RC_CLOSE_EVT     11      /* remote control channel closed */
#define BTA_AVK_REMOTE_CMD_EVT   12      /* remote control command */
#define BTA_AVK_REMOTE_RSP_EVT   13      /* remote control response */
#define BTA_AVK_VENDOR_CMD_EVT   14      /* vendor dependent remote control command */
#define BTA_AVK_VENDOR_RSP_EVT   15      /* vendor dependent remote control response */
#define BTA_AVK_RECONFIG_EVT     16      /* reconfigure response */
#define BTA_AVK_SUSPEND_EVT      17      /* suspend response */
#define BTA_AVK_UPDATE_SEPS_EVT  18      /* update SEPS to available or unavailable */
#define BTA_AVK_META_MSG_EVT     19      /* metadata command/response received */
#define BTA_AVK_RC_CMD_TOUT_EVT  20      /* Timeout waiting for response
                                          * for AVRC command */
#define BTA_AVK_RECONFIG_PENDING 21      /* reconfig pending event */
#define BTA_AVK_RC_PEER_FEAT_EVT 22      /* Peer features notification (sdp results for
                                          * peer initiated AVRC connection) */
#define BTA_AVK_BROWSE_MSG_EVT   23      /* browse command/response received */
...
typedef struct
{
    ...
    UINT16 features;        /* Supported features
                             * (see AVRC_SUPF_* definitions in avrc_api.h) */
} tBTA_AVK_RC_INFO;
...
typedef struct
{
    UINT8           rc_handle;
    UINT8           label;
    tBTA_AVK_CODE   code;           /* AVRCP command or response code
                                     * (see BTA_AVK_CMD_* or BTA_AVK_RSP_* definitions)*/
    tAVRC_MSG       *p_msg;
    UINT16          len;
    UINT8           *p_data;
} tBTA_AVK_META_MSG;
...
**
** Description      Close the current A2DP channel. Close the current AVRCP channel
...
**                  BTA_AVK_FEAT_VENDOR.
**
**                  Note - If company id is 0, the default company ID will be used
**                         from bta_avk_cfg.c. Company id could be BT_SIG_COMP_ID
**                         (0x001958) for AVRCP vendor specific command or assigned
**                         company id.
**
** Returns          void
**
...
**
*******************************************************************************/
BTA_API void BTA_AvkMetaCmd(UINT8 rc_handle, UINT8 label,
                            tBTA_AVK_CMD cmd_code, BT_HDR *p_pkt);
...
**
*******************************************************************************/
BTA_API void BTA_AvkMetaRsp(UINT8 rc_handle, UINT8 label,
                            tBTA_AVK_CODE rsp_code, BT_HDR *p_pkt);
...
/*******************************************************************************
**
** Function         BTA_AvkOpenRcAcp
**
** Description      Opens an AVRCP connection for a peer device as aceptor role.
**                  When connection is open callback function is called
**                  with a BTA_AVK_RC_OPEN_EVT.
**
** Returns          void
**
*******************************************************************************/
BTA_API void BTA_AvkOpenRcAcp(void);
