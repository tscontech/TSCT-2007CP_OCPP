...
**
*******************************************************************************/
BTA_API extern void bta_avk_co_audio_opencfg(tBTA_AVK_CODEC codec_type, UINT8 *p_codec_info,
                                    BD_ADDR addr, UINT8 num_protect, UINT8 *p_protect_info);
...
**
*******************************************************************************/
BTA_API extern void bta_avk_co_video_btc_start(void);
...
**
*******************************************************************************/
BTA_API extern void bta_avk_co_sync_media_start(void);
...
**
*******************************************************************************/
BTA_API extern void bta_avk_co_lpst_sync_ready(void);
