...
#define BTA_STATUS_INVALID_PARMS 6
#define BTA_STATUS_BUSY          7
...
#define BTA_BLE_AD_TYPE_FLAG            BTM_BLE_AD_TYPE_FLAG
#define BTA_BLE_AD_TYPE_16SRV_PART      BTM_BLE_AD_TYPE_16SRV_PART
#define BTA_BLE_AD_TYPE_16SRV_CMPL      BTM_BLE_AD_TYPE_16SRV_CMPL
#define BTA_BLE_AD_TYPE_32SRV_PART      BTM_BLE_AD_TYPE_32SRV_PART
#define BTA_BLE_AD_TYPE_32SRV_CMPL      BTM_BLE_AD_TYPE_32SRV_CMPL
#define BTA_BLE_AD_TYPE_128SRV_PART     BTM_BLE_AD_TYPE_128SRV_PART
#define BTA_BLE_AD_TYPE_128SRV_CMPL     BTM_BLE_AD_TYPE_128SRV_CMPL
#define BTA_BLE_AD_TYPE_NAME_SHORT      BTM_BLE_AD_TYPE_NAME_SHORT
#define BTA_BLE_AD_TYPE_NAME_CMPL       BTM_BLE_AD_TYPE_NAME_CMPL
#define BTA_BLE_AD_TYPE_TX_PWR          BTM_BLE_AD_TYPE_TX_PWR
#define BTA_BLE_AD_TYPE_DEV_CLASS       BTM_BLE_AD_TYPE_DEV_CLASS
#define BTA_BLE_AD_TYPE_SM_TK           BTM_BLE_AD_TYPE_SM_TK
#define BTA_BLE_AD_TYPE_SM_OOB_FLAG     BTM_BLE_AD_TYPE_SM_OOB_FLAG
#define BTA_BLE_AD_TYPE_INT_RANGE       BTM_BLE_AD_TYPE_INT_RANGE
#define BTA_BLE_AD_TYPE_SOL_SRV_UUID    BTM_BLE_AD_TYPE_SOL_SRV_UUID
#define BTA_BLE_AD_TYPE_128SOL_SRV_UUID BTM_BLE_AD_TYPE_128SOL_SRV_UUID
#define BTA_BLE_AD_TYPE_SERVICE_DATA    BTM_BLE_AD_TYPE_SERVICE_DATA
#define BTA_BLE_AD_TYPE_PUBLIC_TARGET   BTM_BLE_AD_TYPE_PUBLIC_TARGET
#define BTA_BLE_AD_TYPE_RANDOM_TARGET   BTM_BLE_AD_TYPE_RANDOM_TARGET
#define BTA_BLE_AD_TYPE_APPEARANCE      BTM_BLE_AD_TYPE_APPEARANCE
#define BTA_BLE_AD_TYPE_ADV_INT         BTM_BLE_AD_TYPE_ADV_INT
#define BTA_BLE_AD_TYPE_32SOL_SRV_UUID  BTM_BLE_AD_TYPE_32SOL_SRV_UUID
#define BTA_BLE_AD_TYPE_32SERVICE_DATA  BTM_BLE_AD_TYPE_32SERVICE_DATA
#define BTA_BLE_AD_TYPE_128SERVICE_DATA BTM_BLE_AD_TYPE_128SERVICE_DATA
#define BTA_BLE_AD_TYPE_MANU            BTM_BLE_AD_TYPE_MANU
typedef tBTM_BLE_AD_TYPE    tBTA_BLE_AD_TYPE;
...
#define BTA_BLE_ADV_DATA_LEN_MAX        31
#define BTA_BLE_SCAN_RSP_DATA_LEN_MAX   31
...
#define BTA_BLE_ADDR_TYPE_PUBLIC        BLE_ADDR_PUBLIC
#define BTA_BLE_ADDR_TYPE_RANDOM        BLE_ADDR_RANDOM
#define BTA_BLE_ADDR_TYPE_RPA_PUBLIC    BLE_ADDR_PUBLIC_ID
#define BTA_BLE_ADDR_TYPE_RPA_RANDOM    BLE_ADDR_RANDOM_ID
typedef UINT8 tBTA_BLE_ADDR_TYPE;

typedef tBLE_BD_ADDR tBTA_BLE_BD_ADDR;

#define BTA_BLE_EVT_CONN_ADV        0x00
#define BTA_BLE_EVT_CONN_DIR_ADV    0x01
#define BTA_BLE_EVT_DISC_ADV        0x02
#define BTA_BLE_EVT_NON_CONN_ADV    0x03
#define BTA_BLE_EVT_SCAN_RSP        0x04
typedef UINT8 tBTA_BLE_EVT_TYPE;
...
typedef struct
{
    ...
    tBTA_BLE_ADDR_TYPE      own_addr_type;          /* Owner bluetooth device address type */
    BD_ADDR                 peer_addr;              /* Peer device bluetooth device address */
    tBTA_BLE_ADDR_TYPE      peer_addr_type;         /* Peer device bluetooth device address type, only support public address type and random address type */
...
typedef struct
{
    UINT16 rx_len;                   /*!< pkt rx data length value */
    UINT16 tx_len;                   /*!< pkt tx data length value */
} tBTA_BLE_pkt_data_length_params;

typedef enum{
    BTA_BLE_WHITELIST_REMOVE     = 0X00,    /*!< remove mac from whitelist */
    BTA_BLE_WHITELIST_ADD        = 0X01,    /*!< add address to whitelist */
} tBTA_BLE_wl_opration;
...
#endif
#define BTA_DM_SP_KEY_REQ_EVT           26      /* Simple Pairing Passkey Notification */
#define BTA_DM_LPST_SWITCH_CMPL_EVT     27      /* LPST role switch complete event */
#define BTA_DM_LPST_SWITCH_REQ_EVT      28      /* LPST role switch request event */
#define BTA_DM_LPST_DISABLED_EVT        29      /* LPST is Disabledd due to BR link role */
#define BTA_DM_LPST_ROLE_UPDATE_EVT     30      /* LPST new role event */
#define BTA_DM_REM_TX_POWER_EVT         31      /* Remote Tx power event */
#define BTA_DM_BLE_DEV_UNPAIRED_EVT     32      /* BLE unpair event */
#define BTA_DM_DEV_UNPAIRED_EVT         33      /* BT unpair event */
#define BTA_DM_LE_FEATURES_READ         34      /* Cotroller specific LE features are read */
#define BTA_DM_ENER_INFO_READ           35      /* Energy info read */
#define BTA_DM_HW_ERROR_EVT             36      /* BT Chip H/W error */
#define BTA_DM_BLE_AUTH_CMPL_EVT        37      /* BLE Auth complete */
#define BTA_DM_BLE_READ_PHY_INFO_EVT    38
#define BTA_DM_BLE_PHY_UPDATE_COML_EVT  39

typedef UINT8 tBTA_DM_SEC_EVT;

#if (BRCM_LPST_INCLUDED == TRUE)
/* LPST disable reason */
#define BTA_DM_LPST_ROLE_FAILED         BTM_LPST_ROLE_FAILED    /* BR link role. */
#define BTA_DM_LPST_SHADOW_FAILED       BTM_LPST_SHADOW_FAILED  /* no shadow HCI handle. */
#endif
...
#define BTA_DM_BLE_ADV_INT_MIN           BTM_BLE_ADV_INT_MIN
#define BTA_DM_BLE_ADV_INT_MAX           BTM_BLE_ADV_INT_MAX

#define BTA_BLE_ISVALID_PARAM(x, min, max)  (((x) >= (min) && (x) <= (max)) || ((x) == BTA_DM_BLE_CONN_PARAM_UNDEF))
...
typedef struct
{
    tBTA_LE_KEY_TYPE      key_mask;       /*!< the key mask to indicate witch key is present */
    tBTA_LE_PENC_KEYS     penc_key;       /*!< received peer encryption key */
    tBTA_LE_PCSRK_KEYS    pcsrk_key;      /*!< received peer device SRK */
    tBTA_LE_PID_KEYS      pid_key;        /*!< peer device ID key */
} tBTA_BLE_BOND_KEY_INFO;                 /*!< ble bond key information value type */

typedef struct
{
    BD_ADDR bd_addr;                      /*!< peer address */
    tBTA_BLE_BOND_KEY_INFO bond_key;      /*!< the bond key information */
} tBTA_BLE_BOND_DEV;
...
#endif
    tBTA_LE_AUTH_REQ auth_mode;         /* The ble authentication complete cb type */
} tBTA_DM_AUTH_CMPL;
...
typedef union
{
    ...
    UINT8               lpst_role;        /* new LPST role */
    tBTA_STATUS         status;             /* LPST switch status */
    UINT8               lpst_disable_reason;/* LPST disable reason */
} tBTA_DM_SEC;
...
typedef void (tBTA_BLE_ENERGY_INFO_CBACK)(tBTA_DM_BLE_TX_TIME_MS tx_time,
                                          ...
                                          tBTA_STATUS status);
typedef void (tBTA_BLE_PHY_INFO_CBACK)( UINT16 usConnId,
                                         UINT8 ucTxPhy,
                                         UINT8 ucRxPhy,
                                         tBTA_STATUS xStatus );
...
BTA_API extern void BTA_DmSetDeviceNameLE(char *p_name);
...
/*******************************************************************************
**
** Function         BTA_DmGetVisibility
**
** Description      This function get the Bluetooth connectable,
...
**
*******************************************************************************/
BTA_API extern void BTA_DmGetVisibility(tBTA_DM_DISC* disc_mode, tBTA_DM_CONN* conn_mode,
                                        UINT8* pairable_mode, UINT8* conn_filter);
...
**
** Description      This function sets the ble visibility mode of local device
**
**
** Returns          void
**
*******************************************************************************/
BTA_API extern void BTA_DmSetBleVisibility(UINT8 enable);

/*******************************************************************************
**
** Function         BTA_DmSetBleLocalFeatures
**
** Description      This function sets the ble supported feature of local device
**
**
** Returns          void
**
*******************************************************************************/
BTA_API extern void BTA_DmSetBleLocalFeatures(UINT8 *set_ble_feature);

/*******************************************************************************
**
** Function         BTA_DmSetBrEdrVisibility
**
** Description     This function sets the bredr visibility mode of local device
**
**
** Returns          void
**
*******************************************************************************/
BTA_API extern void BTA_DmSetBrEdrVisibility(UINT8 enable);

/*******************************************************************************
**
** Function         BTA_DmGetBleLocalFeatures
**
** Description      This function gets the ble supported feature of local device
**
**
** Returns          void
**
*******************************************************************************/
BTA_API extern void BTA_DmGetBleLocalFeatures(UINT8 *get_ble_feature);

/*******************************************************************************
**
** Function         BTA_DmGetBleRmtFeatures
**
** Description      This function gets the ble supported feature of local device
**
**
...
**
*******************************************************************************/
BTA_API extern void BTA_DmGetBleRmtFeatures(BD_ADDR remote_bda, UINT8 *get_ble_feature);
...
/*******************************************************************************
**
** Function         BTA_DmIsConnectionUp
**
** Description      This function return if device is up
**
**
** Returns          void
**
*******************************************************************************/
BOOLEAN BTA_DmIsConnectionUp(BD_ADDR bd_addr, tBT_TRANSPORT *transport);
...
BTA_API extern tBT_TRANSPORT BTA_DmGetDeviceType( BD_ADDR bd_addr );
...
**
*******************************************************************************/
BTA_API extern void BTA_DmAddBleDevice(BD_ADDR bd_addr, tBLE_ADDR_TYPE addr_type, int auth_mode,
                                       tBT_DEVICE_TYPE dev_type);
...
BTA_API extern void BTA_DmSetBleAdvParamsAll (UINT16 adv_int_min, UINT16 adv_int_max,
...
**
*******************************************************************************/
BTA_API extern void BTA_DmBleConfigLocalPrivacy(BOOLEAN privacy_enable, tBTA_SET_LOCAL_PRIVACY_CBACK *set_local_privacy_cback);
...
**
*******************************************************************************/
BTA_API void BTA_DmBleSetAdvConfigRaw (UINT8 *p_raw_adv, UINT32 raw_adv_len,
...
/*******************************************************************************
**
** Function         BTA_DmBleSetScanRspConfigRaw
**
...
**
*******************************************************************************/
extern void BTA_DmBleSetScanRspConfigRaw (UINT8 *p_raw_scan_rsp, UINT32 raw_scan_rsp_len,
...
**
*******************************************************************************/
void BTA_DmBleObserve(BOOLEAN start, UINT8 duration, tBTA_DM_SEARCH_CBACK *p_results_cb);
...
extern void BTA_DmBleReadConnPhyInfo(UINT16 handle, tBTA_BLE_PHY_INFO_CBACK *p_cmpl_cback);

extern void BTA_DmBleReadConnPhyInfo(UINT16 handle, tBTA_BLE_PHY_INFO_CBACK *p_cmpl_cback);

extern void BTA_DmBleCreateConnection(BD_ADDR bd_addr, BOOLEAN is_direct);
#endif
...
**
*******************************************************************************/
BTA_API extern void BTA_DmSetLocalDeviceAddr (BD_ADDR local, tBTA_SET_ADDR_CMPL_CBACK *p_cback);
...
BTA_API extern void bta_lpst_switch (void);
