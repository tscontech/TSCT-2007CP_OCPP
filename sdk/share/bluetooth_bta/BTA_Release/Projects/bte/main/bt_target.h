...
**  Name:          bt_target.h
**
**  Description:   this file contains definitions that will probably
...
#ifndef BLE_SCAN_FILTER
#define BLE_SCAN_FILTER                 FALSE
#endif
...
#ifndef BTM_BLE_FAST_ADV_ENABLE
#define BTM_BLE_FAST_ADV_ENABLE     FALSE
#endif
...
/* The MTU size for the L2CAP configuration.
   It cannot be more than the size of buffer
   pool of SDP_POOL_ID minus headers */
#ifndef SDP_MTU_SIZE
...
/* define GPIO for REG_ON signal */
#ifndef BT_REG_ON_GPIO
#define BT_REG_ON_GPIO                  UPIO_GENERAL3
#endif
...
/******************************************************************************
**
** Flag used to indicate if the code has to be excluded from the stack code.
** By default is set to FALSE (i.e. for the code to be included).
**
******************************************************************************/
#ifndef HCI_NOT_USED_FOR_STACK
#define HCI_NOT_USED_FOR_STACK  FALSE
#endif
