...
**  Name:          gki_target.h
**
**  Description:   this file contains platform-specific GKI defintions
...
#else
/* GKI Trace Macros */
#define GKI_TRACE_0     printf
#define GKI_TRACE_1     printf
#define GKI_TRACE_2     printf
#define GKI_TRACE_3     printf
#define GKI_TRACE_4     printf
#define GKI_TRACE_5     printf
#define GKI_TRACE_6     printf
#define GKI_TRACE_7     printf

#define GKI_TRACE_ERROR_0     printf
#define GKI_TRACE_ERROR_1     printf
#define GKI_TRACE_ERROR_2     printf
#define GKI_TRACE_ERROR_3     printf
#define GKI_TRACE_ERROR_4     printf
#define GKI_TRACE_ERROR_5     printf
#define GKI_TRACE_ERROR_6     printf
#define GKI_TRACE_ERROR_7     printf
#endif
