 ...
 */
    ...
    // init socket device
#if defined(CFG_NET_ENABLE) && !defined(CFG_NET_WIFI_REDEFINE) && !defined(CFG_USBD_NCM) && \
        !defined(CFG_NET_WIFI_SDIO_NGPL_AP6256) && !defined(CFG_NET_WIFI_SDIO_NGPL_AP6236) && \
    ...
    // init drive table
#if defined(CFG_FS_FAT) || defined(CFG_FS_LF)
...
#endif
#ifdef CFG_FS_LFS
    ioctl(ITP_DEVICE_LFS, ITP_IOCTL_DISABLE, NULL);
    ioctl(ITP_DEVICE_LFS, ITP_IOCTL_EXIT,    NULL);
#endif
}
