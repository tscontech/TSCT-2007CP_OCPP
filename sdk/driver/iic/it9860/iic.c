    ...
    IIC_PORT port)
{
    ...
    if (IicDevices[port].port == IIC_PORT_0)
    {
        ithWriteRegA(ITH_GPIO_BASE + 0x238, (0 << 15) | (0 << 31) | (IicDevices[port].ioSCLK << 16) | (IicDevices[port].ioSDA));
    }
#endif
#ifdef CFG_I2C1_ENABLE
    if(IicDevices[port].port == IIC_PORT_1)
    {
        ithWriteRegA(ITH_GPIO_BASE + 0x23c, (0 << 15) | (0 << 31) | (IicDevices[port].ioSCLK << 16) | (IicDevices[port].ioSDA));
    }
#endif
#ifdef CFG_I2C2_ENABLE
    if(IicDevices[port].port == IIC_PORT_2)
    {
        ithWriteRegA(ITH_GPIO_BASE + 0x240, (0 << 15) | (0 << 31) | (IicDevices[port].ioSCLK << 16) | (IicDevices[port].ioSDA));
    }
#endif
#ifdef CFG_I2C3_ENABLE
    if(IicDevices[port].port == IIC_PORT_3)
    {
        ithWriteRegA(ITH_GPIO_BASE + 0x244, (0 << 15) | (0 << 31) | (IicDevices[port].ioSCLK << 16) | (IicDevices[port].ioSDA));
    }
#endif
#endif     
    return;
