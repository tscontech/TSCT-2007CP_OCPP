...
#define BUILD_SDIO
#define CONFIG_8723D_SDIO

struct sdio_func *wifi_sdio_func = NULL;

static const struct sdio_device_id sdio_ids[] = {
	{ SDIO_DEVICE(0x024c, 0xD723),.driver_data = (void *)RTL8723B}
};
...
int wifi_fake_driver_probe_8189es(struct sdio_func *func)
{
	...
	printk("wifi: wifi_fake_driver_probe_8189es enter(%s)\n", (func == NULL) ? "sdio_func is Null":"sdio_func is ok");
