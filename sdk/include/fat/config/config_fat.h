...
/* Maximum length of short/long filename with full path (excluding drive letter) */
...
/****************************************************************************
 *
 * Set F_DIR_WALK_SUPPORT to enable f_dir_walk() call
 *
 ***************************************************************************/
#define F_DIR_WALK_SUPPORT       1

/* Maximum directory depth to walk */
#define F_DIR_WALK_MAX_DIR_DEPTH 16



/****************************************************************************
 *
 * Set F_DISK_USAGE_SUPPORT to enable f_disk_usage() call
 * It uses f_dir_walk() function.
 *
 ***************************************************************************/
#if ( F_DIR_WALK_SUPPORT != 0 )
 #define F_DISK_USAGE_SUPPORT 1
#endif
