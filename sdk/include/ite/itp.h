...
typedef enum
{
    ...
    ITP_DEVICE_LFS           = (88 << ITP_DEVICE_BIT),       // < littlefs
    ITP_DEVICE_YAFFS2        = (89 << ITP_DEVICE_BIT),       // < yaffs2
    ITP_DEVICE_LAST
} ITPDeviceType;
...
#define ITP_IOCTL_RTC_ADJUST_DISABLE  125  ///< Stop AdjustRTC task
#define ITP_IOCTL_FORMAT_PARTITION    126  ///< Format some partition on some disk
...
extern const ITPFSDevice itpLittlefsDevice;       ///< littlefs device
