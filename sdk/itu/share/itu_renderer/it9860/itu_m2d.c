...
#ifdef HUD
static GFXSurface* tempImg;
//static GFXSurface* Lcdsuf;

#define Block_W 16//4//8
#define Block_H 4//8
#define W_num 50//200//100   // 800/Block_W
#define H_num 120//60   //480/Block_H
#endif
...
static void M2dHWFlip(ITUSurface *surf)
{
...
#endif
    {
        ...
        if (gfxGetHUDTable() != 3)
        {
            ...
            surface.dstX = 0;
            surface.dstY = 0;
            surface.dstWidth = 800;
            surface.dstHeight = 480;
...
void ituM2dInit(void)
{
    ...
    tempImg = gfxCreateSurface(800, 480, 800 * 2, GFX_COLOR_RGB565);
