...
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_WVT)
...
if (DEFINED CFG_AUDIO_ENABLE)
    ...
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BUILD_SPEEX)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BUILD_AUDIO_PREPROCESS)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BUILD_FFMPEG)
...
if (DEFINED CFG_VIDEO_ENABLE)
    ...
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_JPG_INTERACTIVE_ENABLE)
		ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_DYNAMIC_ROTATE_ENABLE)
...
if (DEFINED CFG_FS_LFS)
    math(EXPR CFG_LFS_NOR_PTADDRESS "${CFG_NOR_RESERVED_SIZE}-256")
    message(STATUS "CFG_LFS_NOR_PTADDRESS=${CFG_LFS_NOR_PTADDRESS}")
    add_definitions(
        -DCFG_FS_LFS
        -DCFG_LFS_NOR_PTADDRESS=${CFG_LFS_NOR_PTADDRESS}
        -DLFS_THREADSAFE=1
        )
    set(CFG_BUILD_LITTLEFS 1)
    set(CFG_BUILD_YAFFS2   1)
endif()
...
if ($ENV{CFG_PLATFORM} STREQUAL openrtos)
    if (DEFINED CFG_BUILD_BLUETOOTH)
        add_definitions(
            -DCFG_BUILD_BLUETOOTH
            -DCFG_BUILD_NIMBLE
        )
        if (DEFINED CFG_RTL87323BLE)
            add_definitions(
                -DCFG_RTL87323BLE
                -DCFG_BUILD_BLUETOOTH
            )
		...
		if (DEFINED CFG_BT_HAL_UART0)
			add_definitions(
                -DCFG_BT_HAL_UART0
            )
		endif()
		if (DEFINED CFG_GPIO_BT_REG_ON)
			add_definitions(
				-DCFG_GPIO_BT_REG_ON=${CFG_GPIO_BT_REG_ON}
            )
		endif()
    endif()
endif()
...
if (DEFINED CFG_GPIO_SD0_IO)
	...
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_GPIO_SD0_WIFI_POWER_ENABLE)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_SD0_WIFI_DETECT_ACTIVE_HIGH)
if (DEFINED CFG_GPIO_SD0_WIFI_POWER_ENABLE)
	add_definitions(
        -DCFG_GPIO_SD0_WIFI_POWER_PIN=${CFG_GPIO_SD0_WIFI_POWER_PIN}
	)
endif()
...
#    set(CFG_BUILD_LWIP 1)
    ...
    if (DEFINED CFG_NET_WIFI)
		...
		ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_WIFI_SDIO_NGPL_AP6212)
		ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_WIFI_SDIO_NGPL_AP6203)
    ...
    if (DEFINED CFG_NET_WIFI_SDIO_NGPL OR DEFINED CFG_NET_WIFI_SDIO_NGPL_8723DS OR DEFINED CFG_NET_WIFI_SDIO_SSV OR DEFINED CFG_NET_WIFI_SDIO_NGPL_AP6256 OR DEFINED CFG_NET_WIFI_SDIO_NGPL_AP6236 OR DEFINED CFG_NET_WIFI_SDIO_NGPL_AP6212 OR DEFINED CFG_NET_WIFI_SDIO_NGPL_AP6203)
...
if ($ENV{CFG_PLATFORM} STREQUAL win32)
	...
	link_directories(
            ${PROJECT_SOURCE_DIR}/build/linux/lib/${CFG_CPU_NAME}
	    )
    endif ()
endif()
