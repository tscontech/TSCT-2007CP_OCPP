...
#if defined(CFG_NET_ETHERNET) || defined(CFG_USB_ECM) || defined(CFG_USBH_CD_CDCECM)
...
#endif
	// init socket device
#if defined(CFG_NET_ENABLE) && !defined(CFG_NET_WIFI_REDEFINE) && !defined(CFG_USB_ECM) && !defined(CFG_USBH_CD_CDCECM)
